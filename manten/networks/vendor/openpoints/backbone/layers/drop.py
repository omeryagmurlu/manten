...
def drop_block_2d(
    ...
    with_noise: bool = False,  # noqa: FBT001
    inplace: bool = False,  # noqa: FBT001
    batchwise: bool = False,  # noqa: FBT001
):
...
def drop_path(x, drop_prob: float = 0.0, training: bool = False, scale_by_keep: bool = True):  # noqa: FBT001
